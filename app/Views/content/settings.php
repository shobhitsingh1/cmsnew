...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#resetBtn').click(function(){
			...
			const targetValue = 'Arial, Helvetica, sans-serif';
			$("#fonts option:selected").prop("selected", false);
			...
			<div class="scroll_bg" style="background-color:#fff;height:450px;">
				<div class="scroll-pane" style="height:650px;width:680px;">
							<form name="frmSetting" id="frmSetting" method="post" action="settings.php">
								<?php $row = !empty($query_admin_users) ? $query_admin_users[0] : '';
									
								?> 
                                <div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Header Text Color") ?> </strong> : </div>
                                ...
                                <div class="left">
                                    <div class="admin_form_text_user"><?= t("Header Background Color") ?>: </div>
                                ...
                                <div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Nav Mouseover Color") ?></strong> : </div>
                                ...
                                <div class="left">
                                    <div class="admin_form_text_user"> <strong><?= t("Field Heading Text Color") ?></strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Field Text Color") ?> </strong> : </div>
                                ...
                                <div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Page Background Color") ?></strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Devotional Background Color") ?></strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Devotional Text Color") ?></strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Button Text Color") ?> </strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Button background Color") ?></strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Export background Color") ?></strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Export/Reset Text Color") ?></strong> : </div>
								...
								<div class="left">
                                    <div class="admin_form_text_user"><strong><?= t("Devotional Font") ?>:</strong> : </div>
								...
								<div class="save" style="width:157px;margin-left:248px;" >
									<input type="button"  id="resetBtn" class="btn_2" name="btnreset" value='<?= t("reset") ?>' style="width:72px;">
									
									<input type="submit" class="btn_1" name="btnsubmit" value='<?= t("submit") ?>' style="width:65px;">
                                </div>	
							</form>
					</div>
			</div>
